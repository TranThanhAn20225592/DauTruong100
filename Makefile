...
# Source files
SERVER_SRC = tcp_server/server.c tcp_server/account.c tcp_server/handle_request.c tcp_server/join.c tcp_server/player.c tcp_server/question.c tcp_server/game.c
